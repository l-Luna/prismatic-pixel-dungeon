...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		if (landscape()) {
			...
			btnRankings.setRect(btnPlay.left(), btnNews.bottom() + GAP, (btnPlay.width()*.67f)-1, BTN_HEIGHT);
			...
			btnBadges.setRect((w - btnRankings.width()) / 2, btnRankings.top(), btnRankings.width(), BTN_HEIGHT);
			btnNews.setRect(btnRankings.left(), btnRankings.bottom()+ GAP, btnRankings.width(), BTN_HEIGHT);
			btnRankings.setPos(btnNews.left(), btnNews.top());
